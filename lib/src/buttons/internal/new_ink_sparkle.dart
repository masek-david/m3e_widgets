...
/// {@tool snippet}
///
/// For typical use, pass the [NewInkSparkle.splashFactory] to the `splashFactory`
...
/// ```
/// {@end-tool}
class NewInkSparkle extends InteractiveInkFeature {
  ...
  NewInkSparkle({
    ...
    _NewInkSparkleFactory.initializeShader();
    ...
    _sparkleAlpha = TweenSequence<double>(<TweenSequenceItem<double>>[
      TweenSequenceItem<double>(tween: Tween<double>(begin: 0.0, end: 1.0), weight: 13),
      TweenSequenceItem<double>(tween: ConstantTween<double>(1.0), weight: 27),
                                                                                  // EDIT change 50 to 10
      TweenSequenceItem<double>(tween: Tween<double>(begin: 1.0, end: 0.0), weight: 10),
      // EDIT add constant 0
      TweenSequenceItem<double>(tween: ConstantTween<double>(0.0), weight: 50),
    ]).animate(_animationController);
    ...
    assert(() {
      ...
      turbulenceSeed ??= _NewInkSparkleFactory.constantSeed;
      return true;
    }());
  ...
  // EDIT from 617 to 825
  static const Duration _animationDuration = Duration(milliseconds: 825);
  ...
  static const InteractiveInkFeatureFactory splashFactory = _NewInkSparkleFactory();
  ...
  static const InteractiveInkFeatureFactory constantTurbulenceSeedSplashFactory =
      _NewInkSparkleFactory.constantTurbulenceSeed();
  ...
  void paintFeature(Canvas canvas, Matrix4 transform) {
    ...
    if (_NewInkSparkleFactory._program == null) {
    ...
    if (!_fragmentShaderInitialized) {
      _fragmentShader = _NewInkSparkleFactory._program!.fragmentShader();
  ...
  void _updateFragmentShader() {
    ...
    // EDIT this makes the noise bigger, more like native, 0.7 to make it slightly bigger
    final double dpr = ui.PlatformDispatcher.instance.views.first.devicePixelRatio * 0.7;
    ...
    _fragmentShader
      ...
      ..setFloat(1, _color.g)
      ..setFloat(2, _color.b)
      // EDIT use half the opacity of the overlay color to be more in line with native
      ..setFloat(3, _color.a / 2)
      // Composite 1 (u_alpha, u_sparkle_alpha, u_blur, u_radius_scale)
      ..setFloat(4, _alpha.value)
                                    // EDIT i made .5 up to make it look like native
      ..setFloat(5, _sparkleAlpha.value * .5)
      ..setFloat(6, 1.0)
      ...
      // uResolutionScale
      // EDIT replace 1.0 with dpr - to draw physical pixel sized instead of logical
      ..setFloat(11, dpr / _width)
      ..setFloat(12, dpr / _height)
      // uNoiseScale
  ...
  ///
  /// For examples on how the function is used, see [NewInkSparkle] and [paintInkCircle].
  ...
  ///
  /// For examples on how the function is used, see [NewInkSparkle].
  void _clipCanvas({
...
class _NewInkSparkleFactory extends InteractiveInkFeatureFactory {
  const _NewInkSparkleFactory() : turbulenceSeed = null;

  const _NewInkSparkleFactory.constantTurbulenceSeed()
    : turbulenceSeed = _NewInkSparkleFactory.constantSeed;
  ...
  static void initializeShader() {
    if (!_initCalled) {
      ui.FragmentProgram.fromAsset('packages/m3e_widgets/shaders/new_ink_sparkle.frag').then((ui.FragmentProgram program) {
        _program = program;
      });
      _initCalled = true;
    }
